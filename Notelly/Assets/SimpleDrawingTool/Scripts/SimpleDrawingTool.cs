...
namespace SimpleDrawCanvas.Presentation
{
    public class SimpleDrawingTool : MonoBehaviour
    {
        ...
        private bool IsInRectangle(Vector3 position)
        {
        ...
        private void StartDraw(Vector3 startPos)
        {
        ...
        private void MoveDraw(Vector3 movedPosition)
        {
            if (!_isDrawing)
            {
                return;
        ...
        /// </summary>
        private void ApplyConfig(BrushConfig config)
        {
            if (_material == null)
            {
        ...
        private void Draw(Vector2 screenPos)
        {
            ...
            Vector4 normalizedPos = NormalizePosition(pos);
        ...
        private void TryDraw(Vector3 screenPos)
        {
